    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create', models.DateTimeField(auto_now_add=True)),
                ('tag', models.TextField(blank=True, default='Tags')),
                ('views', models.CharField(default=0, max_length=255)),
                ('comments', models.ManyToManyField(blank=True, related_name='tweetComment', to='posts.comment', verbose_name='tweetComments')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(blank=True, related_name='replylikes', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bio', models.TextField(blank=True, default='Welcome to my Profile')),
